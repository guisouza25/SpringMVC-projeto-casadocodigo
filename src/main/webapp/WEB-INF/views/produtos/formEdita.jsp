...
<body>
	...
	<form:form servletRelativeAction="/produtos/alterar/${produto.id }" method="post" modelAttribute="produto" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<input type="hidden" name="sumarioPath" value="${produto.sumarioPath }" >
		</div>
